...
#include <nil/xit/test/frame/view/Global.hpp>
...
namespace nil::xit::gtest::builders::view::global
{
    ...
    public:
        ...
        Frame& value(std::string value_id, Z unrelated_value)
        {
            values.emplace_back([value_id = std::move(value_id),
                                 ...
                                 )](nil::xit::test::frame::view::global::Info& info)
    ...
    protected:
        ...
        std::vector<std::function<void(nil::xit::test::frame::view::global::Info&)>> values;
        // NOLINTNEXTLINE(cppcoreguidelines-non-private-member-variables-in-classes)
